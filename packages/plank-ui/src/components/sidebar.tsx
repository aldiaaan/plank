...
import { useIsMobile } from "@plank/ui/hooks/use-mobile"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@plank/ui/components/sheet"
import { Skeleton } from "@plank/ui/components/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-0 overflow-auto [--radius:var(--radius-xl)] group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
